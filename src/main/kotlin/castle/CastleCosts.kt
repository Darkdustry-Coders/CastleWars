...
object CastleCosts {
    ...
    fun load() {
        units = OrderedMap.of(
            ...
            UnitTypes.crawler, UnitData(35, 0, 7),
            ...
            UnitTypes.quad, UnitData(5700, 29, 950),
            UnitTypes.oct, UnitData(13000, 65, 1300),

            UnitTypes.stell, UnitData(260, 2, 100),
            UnitTypes.locus, UnitData(800, 4, 250),
            UnitTypes.precept, UnitData(2100, 12, 630),
            UnitTypes.vanquish, UnitData(4800, 25, 950),
            UnitTypes.conquer, UnitData(10000, 60, 1700),

            UnitTypes.merui, UnitData(265, 2, 95),
            UnitTypes.cleroi, UnitData(780, 3, 350),
            UnitTypes.anthicus, UnitData(2250, 13, 700),
            UnitTypes.tecta, UnitData(5100, 25, 1000),
            UnitTypes.collaris, UnitData(12500, 60, 2100),
            ...
            UnitTypes.disrupt, UnitData(12000, 47, 2350),
